...
export function InfoCard() {
  return (
    <div className={styles.card}>
      <span className={styles.kicker}>User info</span>
      <strong className={styles.name}>{siteConfig.name}</strong>
      <span className={styles.sub}>{siteConfig.role}</span>
      <span className={styles.subGap} aria-hidden="true" />
      <span className={styles.sub}>{siteConfig.blurb}</span>

      <dl className={styles.rows}>
        <dt className={styles.key}>Email</dt>
        <dd className={styles.value}>
          <a className={styles.mail} href={`mailto:${siteConfig.contactEmail}`}>
            {siteConfig.contactEmail}
          </a>
        </dd>

        <dt className={styles.key}>Location</dt>
        <dd className={styles.value}>{siteConfig.location}</dd>

        <dt className={styles.key}>Links</dt>
        <dd className={styles.value}>
